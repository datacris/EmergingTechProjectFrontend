...
function Home(props) {
    ...
    const slides = [
        { title: 'Patient Care Tracking', description: 'This app helps patient to be in touch with nurse practitioners', image: 'https://www.nurseoncall.ie/_fileupload/Image/Homepage_Banner3.jpg_Thumbnail0.jpg' },
        ...
        <div>
            ...
            <div className="container container__custom">
                ...
                <section className="jumbotron text-center bg-light p-5 rounded jumbotron__custom home__custom">
                    ...
                    <div className="slides_home__custom">
                    ...
                    <div className='logo_home__custom'>
                        <img src={logo} alt='' />
                    </div>
